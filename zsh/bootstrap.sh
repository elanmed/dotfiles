...
if [[ -d "${syntax_dir}" ]]
then
  h_cecho --noop "zsh-syntax-highlighting already installed"
else
  h_cecho --doing "cloning zsh-syntax-highlighting"
...
if [[ -d "${suggest_dir}" ]]
then
  h_cecho --noop "zsh-autosuggestions already installed"
else
  h_cecho --doing "cloning zsh-autosuggestions"
